...
/**
 * Created by LWF on 2014/11/5.
 *
 * 中间带有进度百分比文字显示的环形进度条
 * <p>该类是对 CircularProgressBar（环形进度条）类的一个包装，添加了 文字显示部分</p>
 * <p>实现了 进度条进度改变的监听 {@link com.lwf.ratetextcircularprogressbar.CircularProgressBar.OnProgressChangeListener}，
 * 从而得到进度的百分比，然后显示到 TextView 上</p>
 *
 */
